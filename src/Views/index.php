...
<div class="container">
    ...
    <table style="width:60%; border:1px solid black" class="table table-sm mx-auto mt-5">
        <tr>
        ...
        <tr>
            ...
            <td class="text-right"><button class="btn btn-outline-primary"><a href="src/Views/update.php?id=<?php echo htmlspecialchars($task['id'], ENT_QUOTES) ?>">Edit</a></button></td>
        </tr>
    </table>
    <?php endforeach; ?>
</div>
